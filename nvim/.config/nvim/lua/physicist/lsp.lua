...
keymap("n", "[e", require("lspsaga.diagnostic").goto_prev, { silent = true, noremap =true })
keymap("n", "]e", require("lspsaga.diagnostic").goto_next, { silent = true, noremap =true })
...
local on_attach = function(client, bufnr)
  ...
  keymap("n", "<space>rn", "<cmd>Lspsaga rename<CR>", { silent = true,noremap = true })
